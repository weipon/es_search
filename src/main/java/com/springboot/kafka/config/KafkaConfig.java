...
import com.springboot.kafka.message.listener.MessageListenerService;
...
public class KafkaConfig {
	...
	public Map<String, Object> consumerConfigs() {
		...
		props.put(ConsumerConfig.GROUP_ID_CONFIG, "kafka-c-1");
...
/*		props.put(ConsumerConfig.AUTO_COMMIT_INTERVAL_MS_CONFIG, "15000");
		...
		//props.put(ConsumerConfig.,10485760);
    ...
    public void start() {
	   ...
	   TopicPartitionInitialOffset topicPartition1=new TopicPartitionInitialOffset("templateTopic",0);
